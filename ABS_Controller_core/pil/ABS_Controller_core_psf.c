/*
 * ABS_Controller_core_psf.c
 *
 * Automatically generated s-function with I/O interface for:
 * Component: ABS_Controller_core
 * Component Simulink Path: ABS_Controller_core
 * Simulation Mode: PIL
 *
 */

#define S_FUNCTION_NAME                ABS_Controller_core_psf
...
static RegMdlInfo rtMdlInfo_ABS_Controller_core[1] = { "",
...
static boolean_T startAndSetupApplication(SimStruct *S)
{
...

  {
    ...
    {
      mxArray * codeGenComponent = mxCreateString("ABS_Controller_core");
      mxArray *rhs[3];
      char * simulinkBlockPath = getSimulinkBlockPath(S);
      if (simulinkBlockPath == NULL) {
        ssSetErrorStatus(S,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (S->mdlInfo->genericFcn != (NULL) &&
    ...
    ssRegModelRefMdlInfo(S, (char *)"ABS_Controller_core",
                         rtMdlInfo_ABS_Controller_core, 1);
  }
